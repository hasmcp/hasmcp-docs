...
**Action:** Radically force a reconnect of the SSE/stdio transport layer on your local client (e.g., restart Claude Desktop) to enforce a fresh capability handshake.
